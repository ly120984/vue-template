<template>
  <div class="big_box_cont demo padding">
    <div class="left_cont">
      <Ztree :list="treeList" :filterButtons="treeButtons" :rightClickButtons="treeButtons" />
    </div>
          ...
          <el-col :span="16">
            <el-form-item class="opration">
              ...
              <el-button @click="onExport">
                <IconFont icon="el-icon-upload2" />导出
              </el-button>
    ...
    <el-dialog title="标题" :visible.sync="dialogVisible" width="600px" :append-to-body="true" center>
      <div class="body">
...
export default {
  ...
  methods: {
    ...
    onDownLoad() {
      window.open("./static/TreeTable.zip");
    },
    onExport() {
    ...
    async initZtreeData() {
      let res = await this.$api.get(
        "/client-platform/permission/function/get_tree_data"
      );
      if (res.status === 1) {
